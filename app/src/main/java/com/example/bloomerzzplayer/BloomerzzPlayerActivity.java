...
public class BloomerzzPlayerActivity extends Activity {

    BloomerzzPlayer player;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bloomerzz_player);
        ...
        if (config == null || TextUtils.isEmpty(config.url)) {
            ...
            player = new BloomerzzPlayer(this);
            ...
            player.setScaleType(TextUtils.isEmpty(config.scaleType) ? BloomerzzPlayer.SCALETYPE_FITPARENT : config.scaleType);
    ...
    public static void play(Activity context, String... url) {
        Intent intent = new Intent(context, BloomerzzPlayerActivity.class);
    ...
    public static class Config implements Parcelable {
        ...
        public void play(String url) {
            this.url = url;
            Intent intent = new Intent(activity, BloomerzzPlayerActivity.class);
