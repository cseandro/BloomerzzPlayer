package com.example.bloomerzzplayer;
...
//                Toast.makeText(activity,"previous",Toast.LENGTH_LONG).show();
    ...
    public BloomerzzPlayer(final Activity activity) {
        try {
...
*/
     ...
     */
    public BloomerzzPlayer seekTo(int msec, boolean showControlPanle){
    ...
    public BloomerzzPlayer forward(float percent) {
    ...
    public BloomerzzPlayer playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public BloomerzzPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public BloomerzzPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public BloomerzzPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public BloomerzzPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public BloomerzzPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public BloomerzzPlayer toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public BloomerzzPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
